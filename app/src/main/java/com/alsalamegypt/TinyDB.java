...
public class TinyDB {
   ...
   * @param theBitmap the image you want to save as a Bitmap
   * @return t if image was saved, f otherwise
   */
   ...
   * @return t if it successfully saved, f otherwise
   */
...
//    }
   ...
   * @return t if it successfully deleted, f otherwise
   */
   ...
   * @return t if writable, f otherwise
   */
   ...
   * @return t if readable, f otherwise
   */
